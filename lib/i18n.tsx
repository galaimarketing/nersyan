...
const translations: Translations = {
  ...
  "reviews.subtitle": { ar: "شارك تجربتك واقرأ تقييمات العملاء الآخرين", en: "Share your experience and read other guests' reviews" },
  "reviews.leaveReview": { ar: "اترك تقييمك", en: "Leave a review" },
  "reviews.customerReviews": { ar: "تقييمات العملاء", en: "Customer reviews" },
  "reviews.namePlaceholder": { ar: "اسمك", en: "Your name" },
  "reviews.commentPlaceholder": { ar: "اكتب تقييمك هنا...", en: "Write your review here..." },
  "reviews.submit": { ar: "إرسال التقييم", en: "Submit review" },
  "reviews.submitting": { ar: "جاري الإرسال...", en: "Submitting..." },
  "reviews.noReviews": { ar: "لا توجد تقييمات معروضة حالياً", en: "No reviews displayed yet" },
  "reviews.pendingNotice": { ar: "تم إرسال تقييمك بنجاح وسيظهر بعد موافقة الإدارة.", en: "Your review was submitted and will appear after admin approval." },
  "reviews.submitFailed": { ar: "تعذر إرسال التقييم، حاول مرة أخرى.", en: "Could not submit review, please try again." },
  ...
  "admin.contactMessages": { ar: "رسائل التواصل", en: "Contact Messages" },
  "admin.contactMessagesDesc": { ar: "رسائل الزوار القادمة من نموذج التواصل", en: "Messages submitted from the website contact form" },
  "admin.reviews": { ar: "التقييمات", en: "Reviews" },
  "admin.reviewsDesc": { ar: "إدارة تقييمات العملاء قبل ظهورها في الصفحة الرئيسية", en: "Moderate customer reviews before they appear on the homepage" },
  "admin.reviewModeration": { ar: "مراجعة التقييمات", en: "Review moderation" },
  "admin.reviewModerationHelp": { ar: "يمكنك قبول أو رفض ظهور أي تقييم في الصفحة الرئيسية", en: "Approve or reject which reviews are shown on the homepage" },
  "admin.noReviewsYet": { ar: "لا توجد تقييمات بعد", en: "No reviews yet" },
  ...
  "admin.inbox": { ar: "صندوق الوارد", en: "Inbox" },
  "admin.contactInboxHelp": { ar: "يمكنك فتح البريد أو الهاتف مباشرة من هذه الرسائل", en: "Open email or phone directly from each message" },
  "admin.noContactMessages": { ar: "لا توجد رسائل تواصل", en: "No contact messages yet" },
  "admin.contactMessagesWillAppear": { ar: "ستظهر الرسائل هنا عند إرسالها من الموقع", en: "Messages will appear here when visitors submit the form" },
  "admin.deleteContactMessageConfirm": { ar: "هل تريد حذف رسالة التواصل هذه؟", en: "Do you want to delete this contact message?" },
  "admin.unread": { ar: "غير مقروء", en: "Unread" },
  ...
  "admin.newContactMessage": { ar: "رسالة تواصل جديدة", en: "New contact message" },
  ...
  "admin.roomStatusAutoSyncHint": {
    ar: "لا يمكن جعل الغرفة متاحة أثناء وجود حجز نشط لها. قم بتعديل/إلغاء الحجز أولاً من صفحة الحجوزات.",
    en: "This room cannot be set to Available while it has an active booking. Update or cancel the booking first from Bookings.",
  },
  "admin.roomStatusForceAvailableHint": {
    ar: "يمكنك جعل الغرفة متاحة. عند الحفظ سيتم إنهاء الحجوزات النشطة المرتبطة بهذه الغرفة تلقائياً.",
    en: "You can set this room to Available. On save, active bookings linked to this room will be closed automatically.",
  },
